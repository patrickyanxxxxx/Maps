...
const root = "modules/test/surge-adaptive-v1.4.0";
...
const moduleText = await readFile(`${root}/iRingo.Maps.Surge-Adaptive-Test.sgmodule`, "utf8");
for (const marker of [
	"CountryCode:\"AUTO\"",
...
console.log("Surge adaptive v1.4.0 integration tests passed");
