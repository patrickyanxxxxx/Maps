...
await writeFile("modules/archive/assets/request.cn.bundle.js", request);
await writeFile("modules/archive/assets/response.cn.bundle.js", response);
await writeFile("modules/archive/legacy/iRingo.Maps.China.Full.Local.yaml", module);

let globalModule = await readFile("modules/archive/legacy/iRingo.Maps.iOS27.Local.v3.yaml", "utf8");
...
await writeFile("modules/archive/legacy/iRingo.Maps.International.3D.Local.yaml", globalModule);
